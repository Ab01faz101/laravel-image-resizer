...
trait LaravelImageResizer
{
    public function resizeAndSave(
        ...
        $imgMd->resize((int) ($imgMd->width() / 1.25), (int) ($imgMd->height() / 1.25));
        ...
        $imgSm->resize((int) ($imgSm->width() / 1.5), (int) ($imgSm->height() / 1.5));
        ...
        $imgXs->resize((int) ($imgXs->width() / 2), (int) ($imgXs->height() / 2));
